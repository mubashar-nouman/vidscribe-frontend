            ...
            <Container>
                <div className="flex flex-col items-center text-center max-w-xl mx-auto">
                    ...
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                        Transform videos into content at scale
                    </h2>
                    <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                        Start free and scale as you grow. Choose the perfect plan for your video content needs.
                    </p>
                </div>
            </Container>
                ...
                <div className="relative flex flex-col flex-1 align-top w-full p-3 h-full break-words text-left gap-4">
                    <div className="flex items-end gap-2">
                        <div className="flex items-end gap-1 flex-shrink-0">
                            <span className="text-3xl md:text-4xl font-bold whitespace-nowrap">
                                ${displayedPrice === 0 ? 0 : <NumberTicker value={displayedPrice} />}
                            </span>
                            {/* In here 120 * 0.8 = 96 and /12 to get monthly price */}
                            <span className="text-lg text-muted-foreground font-medium font-heading whitespace-nowrap">
